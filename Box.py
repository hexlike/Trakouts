...
class Box:
	...
	def __init__(self, *args):
		...
		if len(args) > 4:
			...
			print(str(self.type) + "X: " + str(self.x) + str(self.type) + "Y: " + str(self.y) + str(self.type) + "X: " + str(self.fontX) + str(self.type) + "Y: " + str(self.fontY) + " Text: " + str(self.text))
